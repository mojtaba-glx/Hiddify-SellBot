...
- تکمیل نودسازی و پایدارتر شدن همگام‌سازی چندسروره
- بهبود لینک اشتراک هوشمند، لینک b64 و QR داخلی
- حذف وضعیت‌های فیک نود از خروجی لینک هوشمند و حفظ وضعیت خود ربات
- اضافه شدن Hiddify User Stabilizer برای مشکل فعال‌سازی بعضی نسخه‌های پنل
- مرتب‌سازی لیست کاربران و تمیزتر شدن منوهای دامنه و نود
