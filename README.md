...
- نسخه پایدار جدید با تمرکز روی پرداخت خودکار کارت‌به‌کارت و SMS Verifier
- پشتیبانی بهتر از بانک‌های دارای ۴ رقم کارت و بانک‌های بدون ۴ رقم کارت مثل بلو
- جلوگیری از تایید تکراری SMS و کاهش ریسک رسیدهای فیک
- همگام‌سازی بهتر اپ پیامکی با وضعیت تایید پرداخت در ربات
- تکمیل فیکس‌های نودسازی، لینک اشتراک هوشمند، QR، b64 و محاسبه مصرف چندسروره
- بهبود ابزار نصب، آپدیت امن، AutoStart و SSL Wizard
